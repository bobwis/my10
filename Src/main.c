...
void netif_status_callbk_fn(struct netif *netif) {
	...
	printf(
			"netif: IP address of '%c%c' set to %"U16_F".%"U16_F".%"U16_F".%"U16_F"\n",
...
#ifdef SPLAT1
		{
			const uint16_t pattern[]  = {LED_D1_Pin, LED_D1_Pin|LED_D2_Pin, LED_D1_Pin|LED_D2_Pin|LED_D3_Pin,
						  LED_D1_Pin|LED_D2_Pin|LED_D3_Pin|LED_D4_Pin, LED_D1_Pin|LED_D2_Pin|LED_D3_Pin|LED_D4_Pin|LED_D5_Pin};
...
//			dacdata[i] = 2048;
		...
		HAL_DAC_Start_DMA(&hdac, DAC_CHANNEL_1, dacdata, sizeof(dacdata) >> 1, DAC_ALIGN_12B_R);
